export const ExpenseCategories = [
    ...
    {value:"Clothing",label:"Clothing",subcategories:[]},
    {value:"Medical",label:"Medical",subcategories:[]},
    {value:"Health",label:"Health",subcategories:["Gym Membership"]},
    {value:"Insurance",label:"Insurance",subcategories:["Renter Insurance"]},
    {value:"Discretionary",label:"Discretionary",subcategories:[]},
    ...
    {value:"Vacation",label:"Vacation",subcategories:[]},
...
export const BudgetAccounts = ["Jada","Sean","Joint"];
