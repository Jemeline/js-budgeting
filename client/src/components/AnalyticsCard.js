...
function AnalyticsCard({icon, value, text, color}) {
    ...
    return (
        <>
            <div class="display-above-md" style={{width: "100%", height:"100px"}}>
            ...
            <div class="display-below-md">
                <div class="container-fluid rounded-3" style={{backgroundColor : "rgba(53,55,72,0.7)", width: "100%", height: "200px"}}>
