...
export default function Navigation() {
  ...
  return (
    <div style={{height:'60px',display:'flex',alignItems:'center',justifyContent:'center'}}>
        ...
        <button onClick={()=>history.push('/analytics')} style={{color:'white',backgroundColor:getColor('/analytics'),borderRadius:'25px', outline:'none',borderColor:'transparent',marginLeft:'2%',marginRight:'2%',paddingLeft:'5px',paddingRight:'5px',fontSize:'12px'}}>Analytics</button>
        <button onClick={()=>{logout();history.push('/login')}} style={{color:'white',backgroundColor:'transparent',borderRadius:'25px', outline:'none',borderColor:'transparent',marginLeft:'2%',marginRight:'2%',paddingLeft:'5px',paddingRight:'5px',fontSize:'12px'}}>Logout</button>
    </div>
  );
};
